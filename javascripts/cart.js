...
for (let i = 0; i < cards.length; i++) {
	...
	output.innerHTML += `
      ...
      <span class="text-[16px] lg:text-[25px] font-light mt-2 text-center mb-auto">${cards[i].title}</span>
	  <span class="text-[14px] lg:text-[22px] text-[#AFADB5] line-through"> ${cards[i].oldPrice}</span>
		</span>
      <span class="text-[14px] lg:text-[25px] font-medium"
        >${cards[i].curPrice}
		</span>
